                    ...
                    <div className="card-body">
                        <div className="admin">
                            <div className="admin-avatar">
                                <img  className="blog_img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzOm27sGxkaJur2OESDijcOYGwTcpSCXaoleA4p-HoG36jrYXy" />
                            </div>

                            <div className="admin_container">
                                <small><a className="admin" href="#">Admin</a></small>
                                <a  className="admin_img" href="#"><span>&#x1F451;</span></a>
                                <p><small><span>янв. 8 &#x2027</span><span> 1мин. чтения</span></small></p>
                            </div>
                        </div>
